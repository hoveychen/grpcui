# gRPC UI
[![Build Status](https://travis-ci.org/hoveychen/grpcui.svg?branch=master)](https://travis-ci.org/hoveychen/grpcui/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/hoveychen/grpcui)](https://goreportcard.com/report/github.com/hoveychen/grpcui)
...
In some ways, this is like an extension to [grpcurl](https://github.com/hoveychen/grpcurl).
...
1. `github.com/hoveychen/grpcui`: This package contains the building blocks for embedding a
...
2. `github.com/hoveychen/grpcui/standalone`: This package goes a step further and supplies
...
```shell
go get github.com/hoveychen/grpcui
go install github.com/hoveychen/grpcui/cmd/grpcui
```
